...
public class TelegramJson extends CordovaPlugin {
    ...
    private static void onAuthorizationStateUpdated(TdApi.AuthorizationState authorizationState) {
        if (authorizationState != null) {
            TelegramJson.authorizationState = authorizationState;
        }
        switch (TelegramJson.authorizationState.getConstructor()) {
            ...
            case TdApi.AuthorizationStateClosed.CONSTRUCTOR:
                ...
                break;
            default:
                System.err.println("Unsupported authorization state:" + newLine + TelegramJson.authorizationState);
        }
    }
